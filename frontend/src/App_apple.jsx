...
import { Activity, Cpu, HardDrive, Network, Terminal, Zap, AlertTriangle, Server, Wifi, Command, Trash2, Play } from 'lucide-react';
          ...
          <div style={styles.cardContent}>
            <div style={styles.grid4}>
              <div style={styles.metricCard}>
                ...
                <div style={styles.metricValue}>{systemInfo.platform}</div>
              </div>
              <div style={styles.metricCard}>
                <div style={styles.metricLabel}>CPU Cores</div>
      ...
      <div style={styles.grid2}>
        ...
        {activePanel === 'commands' && (
          <div style={styles.card}>
            ...
            <div style={styles.cardContent}>
              <div style={{textAlign: 'center', padding: '40px 0', color: '#6c757d'}}>
                Command Runner feature coming soon...
              </div>
            </div>
          </div>
        )}
        {activePanel === 'network' && (
          <div style={styles.card}>
            ...
            <div style={styles.cardContent}>
              <div style={{textAlign: 'center', padding: '40px 0', color: '#6c757d'}}>
                Network Hub feature coming soon...
              </div>
            </div>
          </div>
        )}
